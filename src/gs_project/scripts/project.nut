...
{
	reload					=	false
	scene_filename			=	"scenes/preloader.nms"	// "scenes/physic_ball_1.nms" //"scenes/screen_nessy.nms"
	scene					=	0
	...
	function	LoadDemo()
	{
		UISetGlobalFadeEffect(SceneGetUI(g_scene), 1.0)	//	Fade out the whole demo
